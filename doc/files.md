...
* bitfishcoin.conf: contains configuration settings for bitfishcoind or bitfishcoin-qt
* bitfishcoind.pid: stores the process id of bitfishcoind while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by bitfishcoind or bitfishcoin-qt
