...
This document provides guidelines for internationalization of the Bitfishcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitfishcoin_en.ts` remains unchanged.
