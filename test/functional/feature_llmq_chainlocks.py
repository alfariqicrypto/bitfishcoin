...
from test_framework.test_framework import BitfishcoinTestFramework
...
class LLMQChainLocksTest(BitfishcoinTestFramework):
    def set_test_params(self):
        self.set_bitfishcoin_test_params(6, 5, fast_dip3_enforcement=True)
