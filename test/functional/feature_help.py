...
"""Verify that starting bitfishcoind with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitfishcoind with -h for help text")
        ...
        self.log.info("Start bitfishcoind with -version for version information")
