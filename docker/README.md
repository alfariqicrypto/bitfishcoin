...
official/supported Docker Images found at https://hub.docker.com/r/bitfishcoin/bitfishcoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/bitfishcoin/bitfishcoind-develop/ when changing the above text**