Contributing to Bitfishcoin Core
============================

The Bitfishcoin Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to bitfishcoin-qt
...
[Translation Process](https://github.com/Altcoin-Master/bitfishcoin/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Bitfishcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Bitfishcoin
Network Protocol consensus changes.

Whether a pull request is merged into Bitfishcoin Core rests with the project merge
...
Patches that change Bitfishcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bitfishcoin consensus, it must have been
...
The review process is normally fairly responsive on the Bitfishcoin Core repository, however
...
The project leader is the release manager for each Bitfishcoin Core release.
