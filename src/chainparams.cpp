...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000000000003db67b03bb9"); // 0
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0xe3c4a94f20725e4d46c22bb8a0e9614afd8dc91d2ffe3e5b639b1a54444d58ea"); // 0
...
//        }
        ...
        checkpointData = {
          {  {0, uint256S("0xd5c3dac54baf6bb096d7568b00f8ca9350966fa5df76b542a1ec00e493fbb63e")},
		     {10000, uint256S("0x6237544f88eef37b4e2c6017791a4e6d5577533f8fbc3811b2b9d0e62308d7ab")},
		     {120000, uint256S("0xe3c4a94f20725e4d46c22bb8a0e9614afd8dc91d2ffe3e5b639b1a54444d58ea")},
          }
        };

        chainTxData = ChainTxData{
            1691623573,//1672502400,   // * UNIX timestamp of last known number of transactions (Block 0)
