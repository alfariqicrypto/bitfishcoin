    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  bitfishcoin-qt [command-line options]                     \n";
...
All the Bitfishcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 BTSC, 0.01 BTSC, 0.1 BTSC, 1 BTSC and 10 BTSC -- sort of like the paper money you use every day.</li> \
