...
/* BitfishcoinGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* BitfishcoinGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Bitfishcoin"
#define QAPP_ORG_DOMAIN "bitfishcoin.org"
#define QAPP_APP_NAME_DEFAULT "Bitfishcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Bitfishcoin-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Bitfishcoin-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Bitfishcoin-Qt-regtest"
