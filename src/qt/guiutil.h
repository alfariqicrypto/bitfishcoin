...
/** Utility functions used by the Bitfishcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bitfishcoin:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load bitfishcoin specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a bitfishcoin specific theme is activated (light/dark).*/
