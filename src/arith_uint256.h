...
#ifndef BITFISHCOIN_ARITH_UINT256_H
#define BITFISHCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Bitfishcoin only uses this "compact" format for encoding difficulty
...
#endif // BITFISHCOIN_ARITH_UINT256_H
