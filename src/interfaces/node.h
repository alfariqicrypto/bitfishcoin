...
//! Interface for the src/evo part of a bitfishcoin node (bitfishcoind process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a bitfishcoin node (bitfishcoind process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a bitfishcoin node (bitfishcoind process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a bitfishcoin node (bitfishcoind process).
class Node
{
public:
    virtual ~Node() {}
