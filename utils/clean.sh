...
rm -f src/config/bitfishcoin-config.h
...
rm -rf test_bitcoin.coverage/ bitfishcoin-gtest.coverage/ total.coverage/
...
clean_exe src/bitfishcoin-cli
clean_exe src/bitfishcoind
clean_exe src/bitfishcoin-gtest
clean_exe src/bitfishcoin-tx
clean_exe src/test/test_bitfishcoin
clean_exe src/test/test_bitfishcoin_fuzzy
...
clean_dep . src/config/bitfishcoin-config.h.in
